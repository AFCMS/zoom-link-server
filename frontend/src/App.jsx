...
import { PlusIcon, ArrowUpRightIcon, ComputerDesktopIcon } from "@heroicons/react/24/solid"
...
function App() {
	...
	function create_entry() {
		...
		axios
			.post(
				url + "api/create",
				JSON.stringify({ description: addDescription, meeting_id: addMeetingID, passcode: addPasscode })
			)
			.then((response) => {
				console.log(response)
		...
		<div className="flex w-screen flex-row items-center justify-center bg-slate-100 p-0 md:p-2">
			<div className="flex w-full columns-3 flex-col bg-slate-200 md:w-2/6 md:rounded md:border md:border-slate-700">
				<div className="flex h-16 w-full items-center bg-blue-500 p-5">
					<h1 className="h-max text-3xl font-bold text-blue-900">Zoom Link Server</h1>
					<div className="w-max"></div>
					<a className="w-max" href="https://github.com/AFCMS">
						<span className="hidden text-blue-800 md:block">Made by AFCM</span>
					</a>
				</div>
